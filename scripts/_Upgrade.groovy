...
// Ant.mkdir(dir:"D:\Eclipse-Workspace\birt-report-test/birt-report/grails-app/jobs")
//

Ant.property(environment:"env")
grailsHome = Ant.antProject.properties."env.GRAILS_HOME"

// Ant.copy(todir: "${basedir}/web-app/WEB-INF/birt"){fileset(dir: "${pluginBasedir}/lib/birt")}
